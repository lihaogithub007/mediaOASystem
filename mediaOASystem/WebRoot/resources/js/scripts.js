...
*/
    ...
    var handleStyler = function () {
        ...
        var setColor = function (color) {
        	var style_color_href = $("#style_color").attr("href") || "";
        	if(style_color_href.indexOf("/css/style_")){
        		style_color_href = style_color_href.substring(0,(style_color_href.indexOf("/css/style_")+"/css/style_".length));
        	}
            $('#style_color').attr("href", style_color_href + color + ".css");
        }
