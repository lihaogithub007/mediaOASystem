...
import com.yuyu.soft.admin.controller.SectionController;
import com.yuyu.soft.admin.controller.SubSectionController;
...
//    @RequestMapping({ "/admin/init_res.htm" })
    public ModelAndView init_res(HttpServletRequest request, HttpServletResponse response) {
        ...
        //        clzs.add(SectionController.class);版块管理
        //        clzs.add(SubSectionController.class);子版块管理
